...
class TestShellStateTextHelpers:
    ...
    def test_clear_shell_state_text_calls_sidebar(self):
        ...
        layout.google_shell_sidebar.clear_shell_state_text.assert_called_once()
...
class TestFindVisibleOutcome:
    ...
    def test_find_sets_shell_state_text(self):
        ...
        layout.google_shell_sidebar.set_shell_state_text.assert_called_with(
            "Search is ready, use the main search field"
        )
    ...
    def test_find_selects_all_in_search_bar(self):
        layout = _make_mock_layout()
        _call_shell_branch(layout, "find")
        layout.main_window.search_bar.selectAll.assert_called_once()
...
class TestVideosVisibleOutcome:
    ...
    def test_videos_sets_shell_state_text(self):
        ...
        layout.google_shell_sidebar.set_shell_state_text.assert_called_with("Showing videos")
...
class TestDiscoverPresetsVisibleOutcome:
    ...
    @pytest.mark.parametrize("branch,expected_text", [
        ("discover_beach", "Discover preset, Beach"),
        ("discover_mountains", "Discover preset, Mountains"),
        ("discover_city", "Discover preset, City"),
    ])
...
class TestFavoritesDocumentsScreenshots:
    ...
    def test_favorites_sets_state_text(self):
        ...
        layout.google_shell_sidebar.set_shell_state_text.assert_called_with("Showing favorites")
    ...
    def test_documents_sets_state_text(self):
        ...
        layout.google_shell_sidebar.set_shell_state_text.assert_called_with("Showing documents")

    def test_screenshots_sets_state_text(self):
        layout = _make_mock_layout()
        _call_shell_branch(layout, "screenshots")
        layout.google_shell_sidebar.set_shell_state_text.assert_called_with("Showing screenshots")
